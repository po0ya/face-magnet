...
"""Trains a face detector using single gpu. Similar to `tools/train_net.py` of
...
def parse_args():
    ...
    parser.add_argument('--weights', dest='pretrained_model',
                        ...
                        default=None, type=str)
    parser.add_argument('--max_size', dest='pretrained_model',
                        help='initialize with pretrained model weights',
                        default=None, type=str)
    ...
    parser.add_argument('--reload', dest='reload', help='reloading saved weights',
                        action='store_true')
